...
urlpatterns = [
    ...
    path('payments/<str:reference>/status/', PaymentStatusView.as_view(), name='payment-status'),
    path('payments/webhook/', PaymentWebhookView.as_view(), name='payment-webhook'),
    path('payments/webhook/<str:provider>/', PaymentWebhookView.as_view(), name='payment-webhook-provider'),
